...
@section('headline')
    <div class="headline_new">
        ...
        <h2 class="subheading">VR Glasses</h2>
    </div>
@endsection
@section('main')
        ...
        <div class="small_textbox">
            <div class="overflow_small mb-3" data-bs-theme="dark">
                <div class="row g-3 align-items-center hundred">
                    <div class="col-auto">
                        <label>Name</label>
                        <input type="Name" class="form-control" value="Meta Glasses" id="device_name">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="overflow_small mb-3" data-bs-theme="dark">
                <div class="row g-3 align-items-center hundred">
                    <div class="col-auto">
                        ...
                        <input type="Name" class="form-control" value="Meta" id="device_oem">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="overflow_small mb-3" data-bs-theme="dark">
                <div class="row g-3 align-items-center hundred">
                    <div class="col-auto">
                        ...
                        <input type="Name" class="form-control" value="123321" id="device_serial_number">
                    </div>
                </div>
            </div>
        </div>
